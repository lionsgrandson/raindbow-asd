...
const items = [
  {
    ...
    content: `ליווי אישי והדרכה של משלבות בחינוך הרגיל (שילוב יחידני).<br />הדרכת הורים מותאמת להורים שבוחרים לשלב את ילדם.<br />הדרכת צוותים חינוכיים לקיום שילוב יחידני מיטבי ואיכותי.<br />הנחיית בוגרים ומתבגרים בתחומי שינוי ומעבר (צבא, שירות לאומי, תעסוקה, דיור ומיומנויות בין אישיות).<br /><br />בניית הרצאות מותאמות עבור גופים פרטים וציבוריים בנושא אוטיזם – שילוב והכלה.<br /><br />הדרכת מעסיקים כיצד ניתן לשלב בתחומי עבודה שונים אדם על הרצף האוטיסטי.`,
  },
  {
    title: "קצת עלי",
    content: `סיון ורונסקי, אמא לדניאל ומיכאל, שניהם נמצאים על הרצף האוטיסטי.<br />בחינוך מיוחד מאוניברסיטת בר אילן.<br />בחינוך מיוחד מהאוניברסיטה הפתוחה.<br />הכשרה בעקרונות יסוד בהתערבות חינוכית התנהגותית לילדים על רצף האוטיזם.<br />מומחית להוראה מתקנת ואסטרטגיות למידה.<br />פסיכותרפיסטית קוגנטיבית התנהגותית.<br />מאבחנת דידקטית מוסמכת.<br />חוקרת פוסט טראומה אצל הורים לילדים עם אוטיזם.<br />מתאמת שירות לבוגרים עם אוטיזם בתחומי שינוי ומעבר.<br />מנחה ומלווה משפחות לפני ואחרי האבחון, צעד צעד יחד.`,
  },
  {
